...
export function TrackingUpsertDialog({
    ...
    defaultValues?: Partial<TrackingForm>;
}) {
    ...
    return (
        <CrudFormDialog
            ...
            submitLabel={
                editingItem ? 'Guardar cambios' : 'Guardar seguimiento'
            }
            ...
            onSubmit={(event) => {
                ...
                form.transform((data) => ({
                    ...
                    priority_id: data.priority_id
                        ? Number(data.priority_id)
                        : null,
                    outcome_id: data.outcome_id
                        ? Number(data.outcome_id)
                        : null,
            ...
            <div className="grid gap-4 md:grid-cols-2">
                <Field>
                    ...
                    <select
                        ...
                        onChange={(event) =>
                            form.setData('activity_type_id', event.target.value)
                        }
                    >
                    ...
                    {form.errors.activity_type_id && (
                        <FieldError>{form.errors.activity_type_id}</FieldError>
                    )}
                </Field>
                <Field>
                    <Label>Canal</Label>
                ...
                <Field>
                    ...
                    <select
                        ...
                        onChange={(event) =>
                            form.setData('status_id', event.target.value)
                        }
                    >
                    ...
                    {form.errors.status_id && (
                        <FieldError>{form.errors.status_id}</FieldError>
                    )}
                </Field>
                <Field>
                    ...
                    <select
                        ...
                        onChange={(event) =>
                            form.setData('priority_id', event.target.value)
                        }
                    >
                ...
                <Field>
                    ...
                    <select
                        className="h-10 rounded-md border border-input bg-background px-3 text-sm"
                        value={form.data.outcome_id}
                        onChange={(event) =>
                            form.setData('outcome_id', event.target.value)
                        }
                    >
                        <option value="">Sin resultado</option>
                        {catalogs.outcomes.map((item) => (
                            <option key={item.id} value={item.id}>
                                {item.name}
                            </option>
                        ))}
                ...
                <Field>
                    ...
                    <Input
                        ...
                        onChange={(event) =>
                            form.setData('next_action_at', event.target.value)
                        }
                    />
                </Field>
                <Field className="md:col-span-2">
                    ...
                    <textarea
                        ...
                        placeholder='{"duracion_min": 20}'
                        value={form.data.meta}
                        onChange={(event) =>
                            form.setData('meta', event.target.value)
                        }
                    />
                </Field>
            </div>
