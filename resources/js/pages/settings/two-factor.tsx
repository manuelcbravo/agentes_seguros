                    ...
                    {twoFactorEnabled ? (
                        <div className="flex flex-col items-start justify-start space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                ...
                                te solicitará un código seguro al iniciar
                                sesión. Puedes obtenerlo desde tu app
                                autenticadora compatible con TOTP en tu
                                teléfono.
                            </p>
                        ...
                        <div className="flex flex-col items-start justify-start space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                ...
                                pedirá un código seguro en cada inicio de
                                sesión. Este código se obtiene desde tu app
